...
urlpatterns = [
    ...
    path("produtosCampanha/<int:produto_id>/", ProdutosListaCampanha, name="produtosCampanha"),
    path("produtosCampanhaAtivas/", ProdutosListaCampanhaAtivas, name="produtosCampanhaAtivas"),
    ...
    path('produtosCampanha/carrinho/', carrinho, name="carrinho"),
